<footer>
    <div class="main-footer container">
        ...
        <div class="footer-first footer-mobile">
            <div class="logo">
            ...
            <ul>
                ...
                <li>info@lamoolisana.it (per segnalazioni dagli utenti)</li>
        ...
        <div class="footer-second footer-mobile">
            <ul>
        ...
        <div class="footer-third footer-mobile">
            <ul>
